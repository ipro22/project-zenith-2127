      ...
      <main className="pt-24 pb-20 px-6">
        <div className="max-w-6xl mx-auto">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="flex items-end justify-between mb-8 flex-wrap gap-4">
            <div>
              <p className="text-sm text-zinc-500 uppercase tracking-wider mb-2 text-left">Магазин техники</p>
              <h1 className="font-display text-4xl font-bold text-zinc-100 text-left">iPro Store</h1>
